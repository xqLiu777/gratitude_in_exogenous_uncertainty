...
model {
  ...
  
  {
    ...
    for (n in 1:N) {
      ...
      if (pe[n] < 0) {
        mu[n] = slo_o_neg[s] * outcome[n] + slo_p_neg[s] * pe[n];
      } else {
        mu[n] = slo_o_pos[s] * outcome[n] + slo_p_pos[s] * pe[n];
      }
    }
...
generated quantities {
  ...
  
  {
    ...
    for (n in 1:N) {
      int s = subject[n];
      mu = (pe[n] < 0) ? (slo_o_neg[s] * outcome[n] + slo_p_neg[s] * pe[n]) : 
                         (slo_o_pos[s] * outcome[n] + slo_p_pos[s] * pe[n]);
